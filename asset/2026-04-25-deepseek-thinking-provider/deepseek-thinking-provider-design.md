...
- `.bytetrue/architecture/reasoning.md`：更新 DeepSeek 行为为官方 Thinking Mode。
- `.bytetrue/architecture/provider.md`：补充 DeepSeek 是 OpenAI ChatCompletions vendor-specific policy 的例子。
- `.bytetrue/architecture/DESIGN.md`：把总入口里旧的“DeepSeek-R1 inline tag”表述更新为“DeepSeek Thinking Mode / reasoning_content”。
...
- `reasoning_content` 从 DeepSeek 特有字段升级为 OpenAI-compatible visible reasoning 的系统级名词，应写回 `.bytetrue/architecture/reasoning.md`。
...
- [.bytetrue/architecture/DESIGN.md](../../architecture/DESIGN.md)
- [.bytetrue/architecture/provider.md](../../architecture/provider.md)
- [.bytetrue/architecture/reasoning.md](../../architecture/reasoning.md)
- [.bytetrue/architecture/ui-events.md](../../architecture/ui-events.md)
