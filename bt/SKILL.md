...
**横切**：流程跑完发现"值得记下来" → `bt-learn` / `bt-trick` / `bt-decide` / `bt-explore` 沉淀到 `compound/`。
...
| 想法还模糊 / "有想法没想清楚" / "先聊聊" / "不知道是不是新功能" | `bt-brainstorm`（分诊后路由到 design / feature-brainstorm 落盘 / roadmap） |
