...
- write to `architecture/{type}-{slug}.md`, following the naming rules in section 0 of `.bytetrue/reference/shared-conventions.md`, with frontmatter `status: done
current: true` and `last_reviewed` set to today
