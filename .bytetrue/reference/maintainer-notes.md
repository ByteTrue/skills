...
- **managed identical**：共享 contract 文件应当 current / onboard 完全一致，例如 execution modes、implementation review、context manifest、subagent handoff、research-first、worklog report-feed。
