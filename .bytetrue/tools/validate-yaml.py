...
Usage examples:
  ...
  python .bytetrue/tools/validate-yaml.py --dir .bytetrue/features

  # Validate a single file
  python .bytetrue/tools/validate-yaml.py --file .bytetrue/features/2026-04-11-auth/auth-design.md

  # Check that required fields exist in frontmatter
  python .bytetrue/tools/validate-yaml.py --dir .bytetrue/features --require doc_type --require status

  # JSON output for programmatic consumption
  python .bytetrue/tools/validate-yaml.py --dir docs/api --json
